...
namespace CrushIt
{
    public class DocumentParser
    {
        ...
        public br_vector2 ReadVector2()
        {
            return br_vector2.Parse(ReadLine());
        }

        public br_vector3 ReadVector3()
        {
            return br_vector3.Parse(ReadLine());
        }

        public br_vector4 ReadVector4()
        {
            return br_vector4.Parse(ReadLine());
        }
    }
}